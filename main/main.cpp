...
int main(int argc, char **argv) {
  ...
  TString AMBER_DAQ_RECO_FILE = "test_data/phast.u7001.301954.root";
  TString VMM_DAQ_RECO_FILE = "test_data/run201_20230926235051_woHits.root"; //"AMBER_2023_data/run314025_20230926155547_woHits.root";
